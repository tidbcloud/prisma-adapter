...
describe('tx test', () => {
  ...
  await expect(prisma.$transaction([createUser1, createUser2])).resolves.toHaveLength(2);
 ...
 test('tx rollback', async () => {
  ...
  await expect(prisma.$transaction([createUser1, createUser2])).rejects.toThrow();
